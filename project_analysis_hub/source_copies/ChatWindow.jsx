          ...
          >
            ...
            >
              <p style={{ margin: 0, whiteSpace: "pre-wrap", wordBreak: "break-word" }}>
                {streamingContent}
                <span style={{ display: "inline-block", width: 6, height: 14, background: "var(--primary)", borderRadius: 2, marginLeft: 2, animation: "typingPulse 0.8s infinite" }} />
              </p>
            </div>
          </div>
        )}

        {isLoading && !streamingContent && <DynamicLoader />}
      </div>
